    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form action="<?= base_url('auth/reset/' . $this->uri->segment(3) . '/' . $this->uri->segment(4)) ?>" method="POST" class="login100-form validate-form">
                    <div class="wrap-input100 validate-input m-b-26" data-validate="Password is required">
                        ...
                        <span class="focus-input100"><?php echo form_error('password'); ?></span>
                    </div>
