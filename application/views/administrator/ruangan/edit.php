	...
	<div class="section-body">
		<div class="row">
			<div class="col-12 col-md-12 col-lg-12">
				<div class="card">
					<div class="card-body">
						<?php echo form_open('ruangan/edit/' . $ruangan['id']); ?>
						<div class="row">
							<div class="col-md-6">
								...
								<div class="form-group">
									<select name="gedungId" class="form-control select2">
										...
										foreach ($gedung as $value) {
											$selected = ($value['id'] == $ruangan['gedungId']) ? ' selected="selected"' : "";
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<input type="text" name="nama" value="<?php echo ($this->input->post('nama') ? $this->input->post('nama') : $ruangan['nama']); ?>" class="form-control" id="nama" />
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<input type="text" name="jenisRuangan" value="<?php echo ($this->input->post('jenisRuangan') ? $this->input->post('jenisRuangan') : $ruangan['jenisRuangan']); ?>" class="form-control" id="jenisRuangan" />
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<input type="text" name="posisiRuangan" value="<?php echo ($this->input->post('posisiRuangan') ? $this->input->post('posisiRuangan') : $ruangan['posisiRuangan']); ?>" class="form-control" id="posisiRuangan" />
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<input type="text" name="ukuranRuangan" value="<?php echo ($this->input->post('ukuranRuangan') ? $this->input->post('ukuranRuangan') : $ruangan['ukuranRuangan']); ?>" class="form-control" id="ukuranRuangan" />
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<input type="number" name="kapasitasRuangan" value="<?php echo ($this->input->post('kapasitasRuangan') ? $this->input->post('kapasitasRuangan') : $ruangan['kapasitasRuangan']); ?>" class="form-control" id="kapasitasRuangan" />
