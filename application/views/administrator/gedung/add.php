						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="form-group">
									<input type="text" name="namaGedung" value="<?php echo $this->input->post('namaGedung'); ?>" class="form-control" id="namaGedung" />
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<input type="number" name="thnPembangunan" value="<?php echo $this->input->post('thnPembangunan'); ?>" class="form-control" id="thnPembangunan" />
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<input type="number" name="luasGedung" value="<?php echo $this->input->post('luasGedung'); ?>" class="form-control" id="luasGedung" />
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<input type="text" name="alamatGedung" value="<?php echo $this->input->post('alamatGedung'); ?>" class="form-control" id="alamatGedung" />
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<input type="number" name="jmlLantai" value="<?php echo $this->input->post('jmlLantai'); ?>" class="form-control" id="jmlLantai" />
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<input type="number" name="jmlRuangan" value="<?php echo $this->input->post('jmlRuangan'); ?>" class="form-control" id="jmlRuangan" />
