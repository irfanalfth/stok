	...
	<div class="section-body">
		<div class="row">
			<div class="col-12 col-md-12 col-lg-12">
				<div class="card">
					<div class="card-body">
						<?php echo form_open('department/edit/' . $this->uri->segment(3)); ?>
						<div class="row">
							<div class="col-md-6">
								<label for="nameShort" class="control-label"><span class="text-danger">*</span>Nama Pendek</label>
								<div class="form-group">
									<input type="text" name="nameShort" value="<?php echo ($this->input->post('nameShort') ? $this->input->post('nameShort') : $department['nameShort']); ?>" class="form-control" id="nameShort" />
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<input type="text" name="nameLong" value="<?php echo ($this->input->post('nameLong') ? $this->input->post('nameLong') : $department['nameLong']); ?>" class="form-control" id="nameLong" />
